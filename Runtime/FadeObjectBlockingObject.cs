...
namespace Supertactic.FadeObstructionSystem
{
    public class FadeObjectBlockingObject : MonoBehaviour
    {
        ...
        [Tooltip("Keeps rendering shadows event if the object is hidden or obstructed")]
        [SerializeField]
        ...
        private void OnDrawGizmos()
        {
            ...
            {
                Color colorView = ObjectsBlockingView.Count == 0 ? Color.green : Color.red;
                Gizmos.color = colorView;
